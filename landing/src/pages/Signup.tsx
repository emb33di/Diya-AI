  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const waitlistEntry: WaitlistEntry = {
        ...
        hear_about_other: hearAboutOther || null,
      };

      console.log('Attempting to insert:', waitlistEntry);
      ...
      if (error?.code === '23505') {
        ...
        toast({
          ...
          description: "The waitlist table doesn't exist yet. Please create it first.",
          variant: "destructive",
        });
      } else if (error?.code === 'PGRST301') {
        toast({
          title: "Permission Denied",
          description: "Access denied. Please check your Supabase configuration.",
          variant: "destructive",
        });
      } else {
        toast({
