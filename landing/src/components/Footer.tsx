          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex space-x-3">
              ...
              <a 
                ...
                className="group p-2 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 transition-all duration-300 hover:scale-110"
                aria-label="Follow us on Instagram"
              >
                <svg 
                  className="w-4 h-4 text-white group-hover:text-yellow-400 transition-colors duration-300" 
                  fill="currentColor" 
                  viewBox="0 0 24 24"
                >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="group p-2 rounded-full bg-blue-600 hover:bg-blue-700 transition-all duration-300 hover:scale-110"
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="group p-2 rounded-full bg-blue-700 hover:bg-blue-800 transition-all duration-300 hover:scale-110"
