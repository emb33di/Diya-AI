    ...
    <section id="faq" className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6">
      <div className="max-w-4xl lg:max-w-5xl mx-auto">
        <div ref={headerRef} className={`text-center mb-12 sm:mb-16 md:mb-20 scroll-fade-in ${headerVisible ? 'animate' : ''}`}>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold font-inter mb-4 sm:mb-6 leading-tight text-brand-orange">
            Frequently Asked Questions
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-white max-w-2xl mx-auto leading-relaxed px-2">
        ...
        <div ref={faqRef} className={`rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 scroll-scale-in ${faqVisible ? 'animate' : ''}`}>
          <Accordion type="single" collapsible className="w-full space-y-3 sm:space-y-4">
            {faqData.map((faq, index) => (
              ...
              >
                <AccordionTrigger className="text-left text-base sm:text-lg md:text-xl font-semibold hover:text-primary transition-all py-4 sm:py-5 md:py-6 px-4 sm:px-6 no-underline hover:no-underline group min-h-[60px] sm:min-h-[70px] flex items-center text-brand-orange">
                  <span className="group-hover:translate-x-1 transition-transform duration-200 pr-4 leading-tight text-brand-orange">
                    {faq.question}
                  </span>
                </AccordionTrigger>
