...
const ProfileCompletionLock: React.FC<ProfileCompletionLockProps> = ({ 
  ...
  const getFieldDisplayName = (fieldKey: string): string => {
    const fieldMap: Record<string, string> = {
      ...
      'secondary_major_minor_interests': 'Secondary Major/Minor Interests',
  ...
  const getFieldCategory = (fieldKey: string): string => {
    const categoryMap: Record<string, string> = {
      ...
      'intended_majors': 'Academic Profile',
      'secondary_major_minor_interests': 'Academic Profile',
      'career_interests': 'Academic Profile',
