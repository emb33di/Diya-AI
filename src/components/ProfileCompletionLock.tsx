...
const ProfileCompletionLock: React.FC<ProfileCompletionLockProps> = ({ 
  ...
  const getFieldCategory = (fieldKey: string): string => {
    const categoryMap: Record<string, string> = {
      ...
      'college_name': 'Academic Profile',
      'college_graduation_year': 'Academic Profile',
      'college_gpa': 'Academic Profile',
      'test_type': 'Academic Profile',
      'test_score': 'Academic Profile',
