/**
 * BlurredCommentSidebar Component
 * 
 * Comment sidebar specifically for anonymous users viewing the Ivy Readiness Report.
 * Shows only the first sentence of each comment and blurs the rest with a sign-up CTA.
 */
...
import BlurredComment from './BlurredComment';

interface BlurredCommentSidebarProps {
...
const BlurredCommentSidebar: React.FC<BlurredCommentSidebarProps> = ({
  blocks,
  onAnnotationSelect,
