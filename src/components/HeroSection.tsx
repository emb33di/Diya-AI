        ...
        <div className="flex flex-col items-center justify-center min-h-[70vh]">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            <div ref={headerRef} className={`scroll-fade-in ${headerVisible ? 'animate' : ''} mb-4`}>
              <span className="gold-shimmer text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold tracking-wider uppercase">Meet Diya AI</span>
            </div>

            {/* Hero Headline */}
            <div ref={contentRef} className={`scroll-fade-in ${contentVisible ? 'animate' : ''}`}>
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground leading-tight tracking-tight font-inter">
          ...
          <div ref={videoRef} className={`flex justify-center scroll-fade-in ${videoVisible ? 'animate' : ''} relative z-40 w-full mb-8 sm:mb-12`}>
          ...
          {/* Credentials */}
          <div className={`text-center scroll-fade-in scroll-stagger-1 ${contentVisible ? 'animate' : ''} mb-6 sm:mb-8`}>
          ...
          {/* Social Media Links */}
          <div className={`text-center scroll-fade-in scroll-stagger-2 ${contentVisible ? 'animate' : ''}`}>
