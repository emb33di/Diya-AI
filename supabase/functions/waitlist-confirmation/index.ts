...
/** Send an email using Resend */ async function sendEmail(to, subject, html) {
...
/** Generate confirmation email HTML template */ function generateConfirmationEmail() {
  return `
    <!DOCTYPE html>
    <html>
      <head>
...
/** Edge Function entry point */ Deno.serve(async (req)=>{
  try {
