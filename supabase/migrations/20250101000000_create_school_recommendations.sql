...
CREATE INDEX idx_school_recommendations_student_id ON public.school_recommendations(student_id);

-- Create index for school name searches
CREATE INDEX idx_school_recommendations_school ON public.school_recommendations(school);
