#!/usr/bin/env python3
"""
Script to upload essay prompts from JSON file to Supabase database.
"""
...
def upload_essay_prompts():
    ...
    try:
        ...
        result = supabase.supabase.table('essay_prompts').delete().neq('id', '00000000-0000-0000-0000-000000000000').execute()
        ...
        for i in range(0, len(prompts_to_insert), batch_size):
            ...
            result = supabase.supabase.table('essay_prompts').insert(batch).execute()
